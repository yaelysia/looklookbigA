        ...
        "detail_stocks": {
            "002558": {
                ...
                "daily_context": {
                    ...
                    "moving_averages": {"ma5": 28.9, "ma10": 28.4, "ma20": 28.1, "ma60": 25.0},
                    "atr14": 1.9,
...
def test_missing_quote_becomes_critical_failure_without_hiding_error():
    ...
    assert any(x["path"] == "detail_stocks.002558.quote" for x in data["data_quality"]["critical_failures"])
...
def test_existing_snapshot_fields_are_not_removed():
    ...
    assert data["detail_stocks"]["002558"]["quote"]["latest"] == before["detail_stocks"]["002558"]["quote"]["latest"]
    assert data["detail_stocks"]["002558"]["minutes"]["last_price"] == before["detail_stocks"]["002558"]["minutes"]["last_price"]
